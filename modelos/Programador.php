...
class Programador extends Conexion
{
    ...
    {
        $sql = "UPDATE programadores SET progra_nombre = '$this->progra_nombre', progra_apellido = '$this->progra_apellido', progra_dependencia = '$this->progra_dependencia' WHERE progra_codigo= $this->progra_codigo";
        $resultado = $this->ejecutar($sql);
        return $resultado;
    }

    public function eliminar(){
        $sql = "UPDATE programadores SET progra_situacion = 0 WHERE progra_codigo = $this->progra_codigo";
        $resultado = $this->ejecutar($sql);
        return $resultado;
    }
